  ...
  ({ className, type, label, ...props }, ref) => (
    ...
    >
      {label && (
        <label
          htmlFor={label}
          className="block text-sm font-medium leading-6 text-gray-900 whitespace-nowrap font-geist"
        >
          {label}
        </label>
      )}
      <input
        ...
        } placeholder:text-neutral-700/40 placeholder:font-medium caret-orange-500 font-berkeley`}
      />
      <div
